...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/test100/testData/">ddd列表</a></li>
		<li class="active"><a href="${ctx}/test100/testData/form?id=${testData.id}">ddd<shiro:hasPermission name="test100:testData:edit">${not empty testData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="test100:testData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="testData" action="${ctx}/test100/testData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="test100:testData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
